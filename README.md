...
The Data Specification on Human Health and Safety – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Human Health and Safety.
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Human Health and Safety - Core", are not needed as no feature instance can be of a type from that application schema.
